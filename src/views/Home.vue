    ...
    <div class="scroll-container"
      ...
      <div class="scroll-inner"
        ...
        <div class="service-policy"
          ...
          <img :src="info.commonConfigModule.brandDescPicUrl"
               alt />
        </div>
        <!-- 分类 -->
        <ul class="kingkong"
            v-if="info && info.kingKongAreaV4">
          <li class="kingkong-item"
        ...
        <div class="operation-cfg"
             v-if="info && info.operationCfg && info.operationCfg[0]">
          <img :src="info.operationCfg[0].picUrls[0]"
               alt />
        </div>
        <!-- 推荐商品 -->
        <div class="rcmd"
             v-if="rcmdItemList.length > 0">
          <div class="rcmd-title">推荐商品</div>
          <div class="rcmd-list">
            <product v-for="(item, index) in rcmdItemList"
                     :key="index"
